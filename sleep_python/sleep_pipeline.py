...
def write_prism_workbook(dataset, out_path):
    ...
    if profile is not None:
        ...
        timepoints = profile['timepoints']
        ws = wb.create_sheet('ZT Sleep Profile')
        ws.cell(row=1, column=1, value="Sleep per bin, group Mean/SEM/N").font = Font(bold=True, size=12)
        header_row, col = 2, 2
