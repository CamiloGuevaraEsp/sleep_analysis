...
%groups = {'23E10GS_pex16_male';'pex16_control_male';'23E10GS_control_male'};
%groups = {'pmp34_male_sd';	'pmp34_male';	'pmp34_male_sd'};
%groups = {'R58H05_pmp34_female',  'R58H05_pmp34_TRPA1_female', 'x'}
groups = {'27LC', 'WLC','27LW'};
filename = '20260808__24hrs_multiColumnByFly_edited.xlsx'
NumDays =3; 
mult_day_plot = 'no'
...
opts.Sheet = "Day 1 30 min binned sleep";
