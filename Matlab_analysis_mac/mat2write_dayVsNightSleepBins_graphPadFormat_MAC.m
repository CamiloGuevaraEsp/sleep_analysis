...
tic;
try,
    addpath('/Volumes/Camilo_SSD/Sleep_runs/reversibility/20260804'); %...,folderNameN)
catch,
end;
primedir = '/Volumes/Camilo_SSD/Sleep_runs/reversibility/20260804';
xl2read = '20260804_mat2read.xlsx';
